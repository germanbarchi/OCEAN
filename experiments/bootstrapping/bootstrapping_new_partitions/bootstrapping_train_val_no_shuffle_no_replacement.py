...
if __name__=='__main__':
    ...
    df=pd.read_csv('egemaps_new_partition_all_audio-all_audio_complete_set.csv',index_col=0)
    print(df.shape)
    ...
    for i in tqdm.tqdm(range(iterations)):       
        ...
        train = resample(df_train_val, replace=False, n_samples=train_len)
    ...
    df.to_csv('bootstrapping_no_shuffle_no_replacement.csv')
